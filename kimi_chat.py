...
TEMPERATURE = None           # 0.0–2.0 (None = default 1.0); thinking mode recommends 1.0
...
def main():
    ...
    print(f"Kimi Chat (model: {MODEL}, stream: {STREAM}, temp: {TEMPERATURE or 'default'}, mode: {mode})")
